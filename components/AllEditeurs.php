  ...
  <?php foreach ($crawler_editeurs as $key): ?>
    <div class="demo-card-wide mdl-card mdl-shadow--2dp">
      ...
      <div class="mdl-card__supporting-text">
        <p>Le site internet de l'éditeur est : <b><a href="<?php echo $key['site_internet']; ?>"><?php echo $key['site_internet']; ?></a></b></p>
...
<dialog id="dialog" class="mdl-dialog">
  ...
  <form action="newEditeur.php" autocomplete="off" method="post">
    ...
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      ...
      <label class="mdl-textfield__label" for="sample3">site web</label>
    </div>
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
